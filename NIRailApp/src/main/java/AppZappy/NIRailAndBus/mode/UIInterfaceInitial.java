...
import AppZappy.NIRailAndBus.pathfinding.JourneySorting;
import AppZappy.NIRailAndBus.pathfinding.RouteStopPosition;
import AppZappy.NIRailAndBus.pathfinding.SQL_UpcomingTrainsAtStation;
import AppZappy.NIRailAndBus.ui.UIUtils;
import AppZappy.NIRailAndBus.ui.activities.JourneyWindow;
...
class UIInterfaceInitial implements IUIInterface
{
	...
	private AppZappy.NIRailAndBus.delays.IDelaySource delays = null;
...
//			return TimeFormatter.getTimeFromHourMinutes(22, 7);
	...
	{
		delays = new AppZappy.NIRailAndBus.delays.TwitterSource();
	}
