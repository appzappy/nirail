...
public class Vehicle
{
	...
	public GeoPoint getCurrentLocation (short currentTime, double seconds)
	{
		...
		for(int i=1;i<checkpoints.size();i++)
		{
			...
			if (total >= proportion )
			{
				...
				GeoPoint point_previous = checkpoints.get(i-1).location;
				GeoPoint point_next = v.location;
				
				GeoPoint mid = Geolocation.linearStretch(point_previous, point_next, mini_portion);
				return mid;
			}
		}
