...
import AppZappy.NIRailAndBus.mode.MetroMode;
import AppZappy.NIRailAndBus.mode.ProgramMode;
import AppZappy.NIRailAndBus.mode.TrainMode;
...
//        	metroZipData.delete(); 
    ...
    public static SQLiteDatabase getDb()
    {
    	...
    	if (!database.exists())
    	{
    		...
    		if (context != null)
    		{
    			Toast.makeText(context, "Failed to find database file. Is SD Card mounted?", Toast.LENGTH_LONG);
    		}
